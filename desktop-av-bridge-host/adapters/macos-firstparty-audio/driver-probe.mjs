...
export const DEFAULT_DRIVER_BUNDLE_PATH = '/Library/Audio/Plug-Ins/HAL/PhoneAVBridgeAudio.driver';
export const DEFAULT_DRIVER_DEVICE_NAME = 'PhoneAVBridgeAudio 2ch';
...
export async function probePhoneAvBridgeAudioDriver({ expectedDeviceName = DEFAULT_DRIVER_DEVICE_NAME } = {}) {
