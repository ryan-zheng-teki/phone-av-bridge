...
compose exec -T host-agent sh -lc "PULSE_SERVER=unix:/tmp/xdg-runtime/pulse/native pactl list short sources | grep -Eq 'phone_resource_companion_mic_src_|phone_resource_companion_mic_sink_.*\\.monitor'"
